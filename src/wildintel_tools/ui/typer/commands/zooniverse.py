...
def importation(
    ...
    try:
        report = wildintel_tools.ui.typer.zooniverse.upload_collection(
            ...
            n_images_seq=n_images_seq,
            max_interval=max_interval,
            attempts=settings.ZOONIVERSE_CONNECTOR.upload_collection_download_attempts or 5,
            delay=settings.ZOONIVERSE_CONNECTOR.upload_collection_download_delay or 15,
            max_attempts_per_subject=settings.ZOONIVERSE_CONNECTOR.upload_collection_max_attempts_per_subject or 5,
            delay_seconds_per_subject=settings.ZOONIVERSE_CONNECTOR.upload_collection_delay_seconds_per_subject or 30,
            dry_run=dry_run,
